...
# ==========================================
# 配置加载（无死循环：固定读取 /opt/linuxwave_config）
# ==========================================
...
def load_config():
    """强制加载 /opt/linuxwave_config/config.json"""
...
def main():
    parser = argparse.ArgumentParser(description="LinuxWave Package Installer")
    parser.add_argument('--version', action='version', version=f'LinuxWave Package Installer {VERSION}')
