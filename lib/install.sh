...
# Usage: /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Sha0huaZhang/LinuxWave/2.0.0-dev/lib/install.sh)"
...
echo "🌊 Welcome to LinuxWave 2.0RC!"
...
# ==========================================
# 交互式目录选择（arm64 和 amd64 完全一致，都可选 /usr/local）
# ==========================================
...
echo "🌊 Configuration saved to /opt/linuxwave_config/config.json"
echo "🌊 Version saved to /opt/linuxwave_config/VERSION.json"
